...
public class QuizPanel1 extends javax.swing.JPanel {
	/**
	 * 
	 */
	public final JButton answer1 = new JButton("Over Socializing");
	public final JButton answer2 = new JButton("Being a Workaholic and over achiever");
	public final JButton answer3 = new JButton("Finding ways to not be at your desk");
	public final JButton answer4 = new JButton("Constantly fidgeting because you can’t stay still too long");
